...
void* plugin_create(const char*)                  { return new int(0); }
void  plugin_destroy(void* p)                     { delete static_cast<int*>(p); }
void  plugin_free_string(char* s)                 { std::free(s); }
int   plugin_is_done(void*)                       { return 0; }

char* plugin_process(void*, const char* input_json)
{
