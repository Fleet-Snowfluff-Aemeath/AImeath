...
// ---- _GamePluginCtx: owns a Game* instance ----

struct _GamePluginCtx
{
    Game* game = nullptr;
...
// ---- Unified plugin_* C ABI (call once per game .cpp) ----
...
{                                                                  \
    return new _GamePluginCtx();                                      \
}                                                                  \
                                                                   \
void plugin_destroy(void* p)                                          \
{                                                                  \
    auto* ctx = static_cast<_GamePluginCtx*>(p);                      \
...
{                                                                  \
    return static_cast<_GamePluginCtx*>(p)->done ? 1 : 0;             \
}                                                                  \
                                                                    \
